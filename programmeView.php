                                ...
                                <div class="single-blog-post mb-50 wow fadeInUp" data-wow-delay="300ms">
									...
									if($result->num_rows > 0){
										while($row = $result->fetch_assoc()){
											...
											echo '<div class="blog-post-thumb mb-50 bg-img">';
											echo '<img src="'.$row['imgURL'].'" style="height:350px;width:1200px;" alt=""></div>';
											echo '<h2>'.$row['programmeName'].'</h2>';
											echo '<div class="post-meta">';
											echo '<p><span><i class="fa fa-map-marker"></i></span> '.$universityName.'</p>';
											echo '</div>';
											echo '<div class="row"><div class="col-6"><b>Duration: </b></br>'.$row['duration'].'</div>';
											echo '<div class="col-6"><b>Closing Date: </b></br>'.$row['closingDate'].'</div>';
											echo '<div class="col-6"></br><b>Programme Fee: </b></br>RM '.$row['totalFee'].'</div></div>';
											echo '<div></br><b>About this programme</b><br>';
											echo '<p>'.$row['progDescription'].'</p></div>';
											
											
										}
									}
									?>
									<form method="post" action="programmeView.php">
									<input type="submit" name="apply" class="btn academy-btn btn-sm mt-15" value="Apply This Programme">
									</form>
